...
![BIOS界面](image\微信图片_20251205114450_79_173.jpg)
##### ubuntu系统安装
按F12进入启动设备页面，选择启动盘对应的选项，进入到Ubuntu安装程序中

![启动页面](image\微信图片_20251205110609_73_173.jpg)
...
![c++插件安装](image\c++插件安装.png)
![运行成功图示](image\Hello_World运行.png)
### 3.**Git**
- Gitbash安装
- Git和Github绑定
- Git基本命令
